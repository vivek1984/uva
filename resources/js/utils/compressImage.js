 ...
 * Resizes and re-encodes to JPEG until the file is under maxBytes.
...
export async function compressImage(file, maxBytes = 1 * 1024 * 1024) {
 ...
 * Returns an array of { file, compressed, originalSize?, finalSize? }.
 */
export async function compressImages(files, maxBytes = 1 * 1024 * 1024) {
